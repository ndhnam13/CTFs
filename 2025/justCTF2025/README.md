Đưa vào audacity bật chế độ spectrogram sẽ thấy ở phía trên có các vạch cam, đen => cam là 1 và đen là 0, càng dài thì càng nhiều kí tự và ngắn nhất sẽ là 0 kí tự

https://chatgpt.com/share/688dbfa8-7174-800f-98df-3891160c839d 

Nhờ chatgpt hoặc tự tạo script để xuất dữ liệu sử dụng **fft**: high freq = 1, low freq = 0
...
```
PS C:\Users\admin\Desktop\justCTF2025> python .\freq_to_bin.py .\challenge.wav
Extracted 554 segments of 0.2 seconds each
